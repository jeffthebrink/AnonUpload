...
public class AnonFileController {
    ...
    public void upload(MultipartFile file, HttpServletResponse response, String permanent, String comment, String password)
        ...
        AnonFile tempFile = new AnonFile(f.getName(), file.getOriginalFilename(), permanent, comment,
    ...
    public void deleteFile(Integer id,  String password) throws PasswordStorage.InvalidHashException,
